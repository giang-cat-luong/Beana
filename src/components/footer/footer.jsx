      ...
      <div className="flex flex-row px-28 py-16 bg-[#86bb86]">
        ...
        <div className='basis-1/2 flex flex-col pl-4'>
          ...
          <div class="w-full max-w-xl">
            <div class="flex items-center border-b border-[#cbcbcb] py-2">
              <input class="appearance-none bg-transparent border-none w-full text-[#fff] mr-3 py-1 px-2 leading-tight focus:outline-none placeholder:italic placeholder:text-[#d8d8d8]" type="text" placeholder="Địa chỉ email..." aria-label="Full name" />
              <button class="flex-shrink-0 bg-[transparent] hover:bg-[transparent] border-[#cbcbcb] hover:border-[#fff] text-sm border-2 text-white py-2 px-3 rounded" type="button">
                Đăng Ký
              </button>
            </div>
          </div>
          <div class="flex mt-2">
            ...
            <div class="ml-2 text-sm">
              <label for="helper-checkbox" class="text-sm text-[#fff] font-normal'">Bằng cách gửi email của mình,
