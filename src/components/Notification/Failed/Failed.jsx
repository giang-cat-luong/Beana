...
export default function Failed({ isSuccess, setIsSuccess }) {
  ...
  return (
    <div class={`fixed top-12  bg-[#fae5e9] border-t-4 border-[#ad5162] rounded-b text-[#b0233a] px-4 py-3 z-[9999] shadow-md ${!isSuccess ? 'right-0 animate-messageAppear' : 'right-[-480px]'}`}>
      <div class="flex pr-3 ">
        <div class="py-1 pr-3">
