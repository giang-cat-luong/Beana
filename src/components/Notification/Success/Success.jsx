...
export default function Success({ isSuccess, setIsSuccess,title,description }) {

    return (
        <div className={`fixed top-12  bg-[#D6FAE4] border-t-4 border-secondary rounded-b text-[#49b949] px-4 py-3 z-[9999] shadow-md ${isSuccess ? 'right-0 animate-messageAppear' : 'right-[-480px]'}`}>
