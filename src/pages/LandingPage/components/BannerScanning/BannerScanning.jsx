        ...
        <div className='max-w-screen-2xl px-36 flex flex-row '>
            <div className='basis-1/2 bg-[#86BB86] pl-20 py-6 text-[#fff]'>
                ...
                <div className='flex flex-row justify-between pt-2'>
                    <div className=''>
                        <h1 className='font-bold'>Quét bằng điện thoại của bạn để bắt đầu</h1>
                        <p className='pt-[6px]'>Hoặc</p>
                        <button className="mt-3 font-normal text-[#fff] text-[13px] border-2 px-6 py-2 hover:bg-[#49B949] hover:text-[#fff] hover:shadow-md hover:shadow-[#49B949]">Trả Lời Một Vài Câu Hỏi</button>
                    </div>
                    <div>
