            ...
            {page === 0 &&
                <div className="w-full h-full relative top-0 px-32">
                    <div className="">
                        <Webcam
                            ref={webcamRef}
                            className="absolute mx-auto  top-16 left-0 right-[80px] text-center z-10 w-[640px] h-[480px]"
                        />
                        <canvas
                            ref={canvasRef}
                            className="absolute mx-auto  left-2 md:left-0 top-[80px] text-center z-10 w-[420px] h-[500px] "
                        />
